          ...
          <div class="tile">
            <h3 class="tile-title">Edit Brand</h3>
             ...
             <div class="form-group">
                 ...
                 <input type="text" name="name" class="form-control" id="fileInput" class="@error('name') is-invalid @enderror" value="{{ $brand->name}}">
                 @error('name')
             ...
             <div class="form-group">
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <img src="{{ asset($brand->photo )}} " width="100px" height="100px" class="pt-3">
                </div>
